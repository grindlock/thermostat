...
module ADC_SAR_SEQ_P4_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("fad374d8-c0e7-43d1-a455-08ddcd3ade73/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__ADC_net;
	wire [0:0] tmpFB_0__ADC_net;
	wire [0:0] tmpIO_0__ADC_net;
	wire [0:0] tmpINTERRUPT_0__ADC_net;
	electrical [0:0] tmpSIOVREF__ADC_net;
	...
	cy_psoc3_pins_v1_10
		...
		ADC
		 (.oe(tmpOE__ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_net[0:0]}),
		  .analog({Net_387}),
		  .io({tmpIO_0__ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_net),
		  .interrupt({tmpINTERRUPT_0__ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AF_net;
	wire [0:0] tmpFB_0__AF_net;
	wire [0:0] tmpIO_0__AF_net;
	wire [0:0] tmpINTERRUPT_0__AF_net;
	electrical [0:0] tmpSIOVREF__AF_net;

	cy_psoc3_pins_v1_10
		#(.id("916a9613-ead3-4fa3-804f-b7c0f8806587"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		AF
		 (.oe(tmpOE__AF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AF_net[0:0]}),
		  .io({tmpIO_0__AF_net[0:0]}),
		  .siovref(tmpSIOVREF__AF_net),
		  .interrupt({tmpINTERRUPT_0__AF_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
