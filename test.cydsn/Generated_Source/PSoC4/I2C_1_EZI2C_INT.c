...
#include "cyapicallbacks.h"
    ...
    *******************************************************************************/
    ...
    #ifdef I2C_1_EZI2C_STRETCH_ISR_ENTRY_CALLBACK
        I2C_1_EZI2C_STRETCH_ISR_EntryCallback();
    #endif /* I2C_1_EZI2C_STRETCH_ISR_ENTRY_CALLBACK */
                ...
                #endif /* (I2C_1_SECONDARY_ADDRESS_ENABLE_CONST) */
                    {
                        ...
                        case I2C_1_EZI2C_FSM_BYTE_WRITE:
                            if(0u != locBufSize)
                            {
                                ...
                                I2C_1_dataBuffer[locIndex] = (uint8) locByte;
                                locIndex++;
                                locBufSize--;
                            }
                            else
                        ...
                        case I2C_1_EZI2C_FSM_OFFSET_LO8:
                            ...
                            if(locByte < (uint32) I2C_1_bufSizeBuf)
                            {
                                I2C_1_I2C_SLAVE_GENERATE_ACK;
                                ...
                                locBufSize = (uint16) ((locByte < I2C_1_protectBuf) ?
                                                       (I2C_1_protectBuf - locByte) : (0u));
                ...
                else if (0u != (I2C_1_I2C_CTRL_REG & I2C_1_I2C_CTRL_S_READY_DATA_ACK))
                {
                    ...
                    */
                    ...
                    for(; (0u != fifoIndex); fifoIndex--)
                    {
                        ...
                        I2C_1_dataBuffer[locIndex] = (uint8) I2C_1_RX_FIFO_RD_REG;
                        locIndex++;
                    }
                ...
                if(0u != (locIntrSlave & I2C_1_INTR_SLAVE_I2C_ADDR_MATCH))
                {
                ...
                #endif /* (I2C_1_SECONDARY_ADDRESS_ENABLE_CONST) */
                    {
                        ...
                        if(I2C_1_CHECK_I2C_STATUS(I2C_1_I2C_STATUS_S_READ))
                        {
                            ...
                            locBufSize = I2C_1_bufSizeBuf - (uint16) locIndex;
            ...
            */
            if(0u != (I2C_1_GetInterruptCause() & I2C_1_INTR_CAUSE_TX))
            {
                ...
                do
                {
                    ...
                    if(0u != locBufSize)
                    {
                        I2C_1_TX_FIFO_WR_REG = (uint32) I2C_1_dataBuffer[locIndex];
                        locIndex++;
                        locBufSize--;
                    }
                    else
    ...
    #ifdef I2C_1_EZI2C_STRETCH_ISR_EXIT_CALLBACK
        I2C_1_EZI2C_STRETCH_ISR_ExitCallback();
    #endif /* I2C_1_EZI2C_STRETCH_ISR_EXIT_CALLBACK */
    ...
    *******************************************************************************/
    ...
    #ifdef I2C_1_EZI2C_NO_STRETCH_ISR_ENTRY_CALLBACK
        I2C_1_EZI2C_NO_STRETCH_ISR_EntryCallback();
    #endif /* I2C_1_EZI2C_NO_STRETCH_ISR_ENTRY_CALLBACK */
            ...
            if(0u != (locIntrCause & I2C_1_INTR_CAUSE_RX))
            {
                ...
                case I2C_1_EZI2C_FSM_OFFSET_LO8:
                    ...
                    if(locByte < (uint32) I2C_1_bufSizeBuf1)
                    {
                        ...
                        I2C_1_offsetBuf1 = (uint16) locByte;
    ...
    #ifdef I2C_1_EZI2C_NO_STRETCH_ISR_EXIT_CALLBACK
        I2C_1_EZI2C_NO_STRETCH_ISR_ExitCallback();
    #endif /* I2C_1_EZI2C_NO_STRETCH_ISR_EXIT_CALLBACK */
