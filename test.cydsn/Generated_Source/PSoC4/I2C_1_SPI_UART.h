...
#define I2C_1_SPI_MODE                   (0u)
#define I2C_1_SPI_SUB_MODE               (0u)
#define I2C_1_SPI_CLOCK_MODE             (0u)
...
#define I2C_1_SPI_INTR_RX_MASK           (0x0u)
#define I2C_1_SPI_INTR_TX_MASK           (0x0u)
...
#define I2C_1_UART_MP_RX_ADDRESS         (0x2u)
#define I2C_1_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define I2C_1_UART_INTERRUPT_MODE        (0u)

#define I2C_1_UART_INTR_RX_MASK          (0x0u)
#define I2C_1_UART_INTR_TX_MASK          (0x0u)
...
#define I2C_1_UART_RX_BREAK_WIDTH        (11u)
...
****************************************/
    ...
    #define I2C_1_CHECK_SPI_WAKE_ENABLE  ((0u != I2C_1_scbEnableWake) && I2C_1_SCB_MODE_SPI_RUNTM_CFG)
    #define I2C_1_CHECK_UART_WAKE_ENABLE ((0u != I2C_1_scbEnableWake) && I2C_1_SCB_MODE_UART_RUNTM_CFG)
    ...
    /* Internal RX and TX buffer: for SPI or UART */
        ...
        /* Get FIFO size */
        #define I2C_1_SPI_UART_FIFO_SIZE I2C_1_GET_FIFO_SIZE(I2C_1_SPI_BYTE_MODE_ENABLE)
        ...
        /* Get FIFO size */
        #define I2C_1_SPI_UART_FIFO_SIZE I2C_1_GET_FIFO_SIZE(I2C_1_UART_BYTE_MODE_ENABLE)
    ...
    #define I2C_1_CHECK_UART_WAKE_ENABLE (I2C_1_UART_WAKE_ENABLE_CONST)
...
typedef struct
{
    ...
    */
     ...
     *  choices:
     *  - I2C_1_SPI_MODE_MOTOROLA
     *  - I2C_1_SPI_MODE_TI_COINCIDES
     *  - I2C_1_SPI_MODE_TI_PRECEDES
     *  - I2C_1_SPI_MODE_NATIONAL
    */
    uint32 submode;
     ...
     *  - I2C_1_SPI_SCLK_CPHA0_CPOL0
     *  - I2C_1_SPI_SCLK_CPHA0_CPOL1
     *  - I2C_1_SPI_SCLK_CPHA1_CPOL0
     *  - I2C_1_SPI_SCLK_CPHA1_CPOL1
    */
    uint32 sclkMode;
    ...
    */
     ...
     *  choices:
     *  - I2C_1_BITS_ORDER_LSB_FIRST
     *  - I2C_1_BITS_ORDER_MSB_FIRST
    */
    uint32 bitOrder;
     ...
     *  available choices:
     *  - I2C_1_SPI_TRANSFER_CONTINUOUS
     *  - I2C_1_SPI_TRANSFER_SEPARATED
    */
     ...
     *  buffer.
     *  The I2C_1_INTR _RX_NOT_EMPTY interrupt has to be enabled to
    ...
    */
     ...
     *  I2C_1_SPI_SLAVE_SELECT0 corresponds to slave select 0
     *  polarity, bit I2C_1_SPI_SLAVE_SELECT1 – slave select 1
     *  polarity and so on. Polarity constants are:
     *  - I2C_1_SPI_SS_ACTIVE_LOW
     *  - I2C_1_SPI_SS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE /
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S /
     *  PSoC Analog Coprocessor.
...
typedef struct
{
     ...
     *  choices:
     *  - I2C_1_UART_MODE_STD
     *  - I2C_1_UART_MODE_SMARTCARD
     *  - I2C_1_UART_MODE_IRDA
    */
    uint32 mode;
    ...
    */
     ...
     *  - I2C_1_UART_PARITY_EVEN
     *  - I2C_1_UART_PARITY_ODD
     *  - I2C_1_UART_PARITY_NONE
    */
    uint32 parity;

    /** Determines the number of stop bits. The following defines are available
     *  choices:
     *  - I2C_1_UART_STOP_BITS_1
     *  - I2C_1_UART_STOP_BITS_1_5
     *  - I2C_1_UART_STOP_BITS_2
    */
    uint32 stopBits;
     ...
     *  is enabled:
     *  - I2C_1_UART_IRDA_LP_OVS16
     *  - I2C_1_UART_IRDA_LP_OVS32
     *  - I2C_1_UART_IRDA_LP_OVS48
     *  - I2C_1_UART_IRDA_LP_OVS96
     *  - I2C_1_UART_IRDA_LP_OVS192
     *  - I2C_1_UART_IRDA_LP_OVS768
     *  - I2C_1_UART_IRDA_LP_OVS1536
    */
    uint32 oversample;
    ...
    */
     ...
     *  - I2C_1_UART_CTS_ACTIVE_LOW
     *  - I2C_1_UART_CTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE /
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S /
     *  PSoC Analog Coprocessor.
    ...
    */
     ...
     *  - I2C_1_UART_RTS_ ACTIVE_LOW
     *  - I2C_1_UART_RTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE /
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S /
     *  PSoC Analog Coprocessor.
...
/* SPI specific functions */
    ...
    /*******************************************************************************
    * Function Name: I2C_1_SpiIsBusBusy
    ****************************************************************************//**
    *
...
/* UART specific functions */
    ...
    /* UART TX direction APIs */
        ...
        /*******************************************************************************
        * Function Name: I2C_1_UartPutChar
        ****************************************************************************//**
        *
        ...
        *  Use I2C_1_UART_MP_MARK to add a mark to create an address byte.
        *
...
#define I2C_1_INTR_SPIM_TX_RESTORE   (I2C_1_INTR_TX_OVERFLOW)

#define I2C_1_INTR_SPIS_TX_RESTORE     (I2C_1_INTR_TX_OVERFLOW | \
                                                 I2C_1_INTR_TX_UNDERFLOW)
...
#define I2C_1_INTR_UART_TX_RESTORE   (I2C_1_INTR_TX_OVERFLOW  | \
                                                 I2C_1_INTR_TX_UART_NACK | \
                                                 I2C_1_INTR_TX_UART_DONE | \
                                                 I2C_1_INTR_TX_UART_ARB_LOST)
...
***************************************/
    ...
    #define I2C_1_UART_DEFAULT_UART_RX_CTRL \
                    (I2C_1_GET_UART_RX_CTRL_MODE(I2C_1_UART_STOP_BITS_NUM)                    | \
                     ...
                     I2C_1_GET_UART_RX_CTRL_BREAK_WIDTH(I2C_1_UART_RX_BREAK_WIDTH)            | \
