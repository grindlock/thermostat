...
#define I2C_1_EZI2C_PRIMARY_SLAVE_ADDRESS    (0x8u)
#define I2C_1_EZI2C_SECONDARY_SLAVE_ADDRESS  (0x9u)
#define I2C_1_EZI2C_SUB_ADDRESS_SIZE         (0u)
#define I2C_1_EZI2C_WAKE_ENABLE              (0u)
#define I2C_1_EZI2C_DATA_RATE                (100u)
#define I2C_1_EZI2C_SLAVE_ADDRESS_MASK       (0xFEu)
...
****************************************/
    ...
    #define I2C_1_EZI2C_FIFO_SIZE I2C_1_GET_FIFO_SIZE(I2C_1_EZI2C_BYTE_MODE_ENABLE)
...
typedef struct
{
    ...
    */
     ...
     *  - I2C_1_EZI2C_ONE_ADDRESS
     *  - I2C_1_EZI2C_TWO_ADDRESSES
    */
    ...
    */
    ...
    /** Size of sub-address.
     *  - I2C_1_EZI2C_SUB_ADDR8_BITS 
     *  - I2C_1_EZI2C_SUB_ADDR16_BITS
    */
    uint32 subAddrSize;
...
/* Access to global variables */
    ...
    #define I2C_1_EZI2C_SET_OFFSET(activeAddress, locOffset) \
            do{ \
                if(I2C_1_EZI2C_ACTIVE_ADDRESS1 == (activeAddress)) \
                {    \
                    I2C_1_offsetBuf1 = (uint16) (locOffset); \
                }    \
                else \
                {    \
                    I2C_1_offsetBuf2 = (uint16) (locOffset); \
                }    \
            }while(0)
#else
...
#define I2C_1_EZI2C_TX_FIFO_CTRL_SET   (I2C_1_EZI2C_TX_FIFO_CTRL | \
                                                   I2C_1_TX_FIFO_CTRL_CLEAR)
#define I2C_1_EZI2C_TX_FIFO_CTRL_CLEAR (I2C_1_EZI2C_TX_FIFO_CTRL)
#define I2C_1_FAST_CLEAR_TX_FIFO \
                            do{             \
                                I2C_1_TX_FIFO_CTRL_REG = I2C_1_EZI2C_TX_FIFO_CTRL_SET;   \
                                I2C_1_TX_FIFO_CTRL_REG = I2C_1_EZI2C_TX_FIFO_CTRL_CLEAR; \
                            }while(0)
...
#define I2C_1_EZI2C_TX_CTRL  ((I2C_1_ONE_BYTE_WIDTH - 1u) | \
